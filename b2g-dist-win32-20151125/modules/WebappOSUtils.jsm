...
//@line 16 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
...
//@line 50 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
  /**
...
//@line 80 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
...
//@line 92 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
    ...
    return launchTarget;
//@line 171 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
  },

  getInstallPath: function(aApp) {
//@line 175 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
    // All b2g & fennec builds.
    return aApp.basePath + "/" + aApp.id;

//@line 223 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
...
//@line 236 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
...
//@line 244 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
    ...
    return true;
//@line 294 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
  },

  uninstall: function(aApp) {
//@line 298 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
    let appRegKey = this.getAppRegKey(aApp);
...
//@line 377 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
  },
...
//@line 404 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"

    let uniqueName = this.getUniqueName(aApp);

//@line 408 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
    if (!this.getLaunchTarget(aApp)) {
      return false;
    }

    return true;
//@line 466 "c:\mozilla-source\toolkit\webapps\WebappOSUtils.jsm"
  },
